...
st.markdown("---")
st.caption("Notes: This app submits all async calls to one global background loop to avoid worker/event-loop mismatches. Adjust timeouts for large PDFs or slow OCR.")def save_registry(reg):
